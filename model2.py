...
class Cube(BaseModel):
    def __init__(self, app, vert_arr_obj_name='cube', texture_id=0, pos=(0,0,0), rot=(0,0,0), scale=(1,1,1)):
...
class Model(BaseModel):
    def __init__(self, app, vert_arr_obj_name='model', texture_id='model', pos=(0,0,0), rot=(0,0,0), scale=(1,1,1)):
        super().__init__(app, vert_arr_obj_name, texture_id, pos, rot, scale)
        self.on_init()
